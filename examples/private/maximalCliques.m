...
%Used in several places in thesis. This is a general algorithm for finding
% the maximal cliques of a graph. For chordal graphs you can find the
% maximal cliques in a more efficient way of courser ;).
